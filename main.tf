...
# ── VPC ──────────────────────────────────────────────────────────────
module "vpc" {
  source = "git::https://github.com/minakshijapan77-jpg/vpc.git"
...
module "subnets" {
  source = "git::https://github.com/minakshijapan77-jpg/subnet.git"
...
module "ec2_instances" {
  source = "git::https://github.com/minakshijapan77-jpg/ec2.git"
...
# ── S3 Bucket ─────────────────────────────────────────────────────────
module "s3_bucket" {
  source = "git::https://github.com/minakshijapan77-jpg/s3.git"
